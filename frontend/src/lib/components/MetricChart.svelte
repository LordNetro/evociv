  ...
  $effect(() => {
    chart = new Chart(canvas, {
      ...
      data: {
        labels: [],
        datasets: [
          { label: 'Population', data: [], borderColor: '#4CAF50', backgroundColor: '#4CAF50', pointRadius: 0, tension: 0.3 },
          { label: 'Avg Hunger', data: [], borderColor: '#FF9800', backgroundColor: '#FF9800', pointRadius: 0, tension: 0.3 },
          { label: 'Avg Thirst', data: [], borderColor: '#2196F3', backgroundColor: '#2196F3', pointRadius: 0, tension: 0.3 },
        ],
      },
      options: {
        responsive: true,
